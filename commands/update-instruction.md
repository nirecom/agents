...
- `instruction.md` is searched in this order:
  - Local directory `../my-specs-repo/projects/engineering/`
  - git repo `git@github.com:nirecom/my-specs-repo.git` (path: `projects/engineering/instruction.md`)
...
3. **Identify gaps**: Compare against instruction.md. Look for:
   - Host service changes (<redacted> services, Mac services, QNAP docker-stacks)
