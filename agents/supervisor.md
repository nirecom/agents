...
6. Do NOT auto-invoke `/workflow-init` — the main agent resumes the existing session after diagnosis.
...
- Do NOT propose or invoke `/workflow-init` — the main agent resumes the existing session after diagnosis.
