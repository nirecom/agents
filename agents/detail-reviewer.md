...
- **Core principles** — verify the plan applies `rules/core-principles.md`: §1 elevated-perspective check (including merge/replace-class options), §2 orthogonal-family coverage, §3 name-reflects-substance, §4 SSOT (no duplication of canonical sources).
