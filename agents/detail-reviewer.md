...
- **Mandatory carry-forward verify (structural — 3-section orthogonal check per `rules/core-principles.md` CPR-5):**
...
See agents/detail-reviewer/concern-identifiers.md for the Concern Identifiers protocol (Round 1 / Round 2+).
