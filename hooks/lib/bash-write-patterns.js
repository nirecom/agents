...
"use strict";
const { WRITE_PATTERNS, isGhWriteIR, isGitWriteIR } = require("./bash-write-patterns/patterns");
...
module.exports = { WRITE_PATTERNS, classify, classifyDetailed, isReadOnlyInterpreterC, isGhWriteIR, isGitWriteIR, resolveEffectiveCommand, resolveEffectiveArgv };
