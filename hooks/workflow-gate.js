...
if (require.main === module) {
  ...
  const SKILL_MAP = {
    ...
    plan: '/design-approach → /make-detail-plan  OR if unnecessary: echo "<<WORKFLOW_PLAN_NOT_NEEDED: <reason>>" (reason: >=3 non-space chars, no \'>\', not a placeholder)',
    branching_decision: 'consult rules/branch.md + rules/worktree.md, then: echo "<<WORKFLOW_BRANCHING_DECIDED: main|branch: <name>|worktree: <path>>"',
