...
Background: refactor(#970,#860): split tests/hooks/fix-workflow-gate-unix-path.sh per Pattern A

Changes: Refactored 743-line test file `tests/hooks/fix-workflow-gate-unix-path.sh` into a 5-file source-dispatch layout for maintainability (#970)
