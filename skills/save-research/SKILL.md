...
SR-3. **Check for duplicates**: Read `../my-specs-repo/projects/engineering/research-results/`
...
SR-6. **Write the file** to `../my-specs-repo/projects/engineering/research-results/<slug>.md`.
SR-7. **Commit**: Run `git -C ../my-specs-repo add` and `git -C ../my-specs-repo commit` for the new file.
