...
`bash "$AGENTS_CONFIG_DIR/bin/workflow-plans-dir"` — one standalone call; read the printed path and reuse it literally. Canonical: `skills/_shared/resolve-plans-dir.md`.
