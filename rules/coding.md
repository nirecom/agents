...
See also `rules/core-principles.md` for the top-level design principles (elevate perspective / orthogonality / name reflects substance) that govern cross-platform consistency and naming.
