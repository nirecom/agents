...
Work directly on `main` for trivial changes; switch to a feature branch whenever the
change warrants isolation, review, or a clean revert unit.
...
**Not a fit:** single-commit typo / doc fixes, small already-verified config tweaks,
...
If the work also requires parallel sessions, an isolated runtime (Docker / DB / long-running
