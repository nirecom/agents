...
Under `ENFORCE_WORKTREE=on`, `/update-docs` stages user-facing bullets (public repos only) into `WORKTREE_NOTES.md` `## Changelog Notes`. `bin/compose-doc-append-entry` appends them to `CHANGELOG.md` during `/worktree-end` Step WE-21.
