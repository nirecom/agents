#!/usr/bin/env bash
# Contract tests for make-detail-plan research escalation feature
...
echo "=== make-detail-plan research escalation contract tests ==="
echo ""
...
# Ad2: DESIGNER_MD contains 'skill:' (format field)
assert_contains "$DESIGNER_MD" "skill:" \
    "Ad2: DESIGNER_MD contains 'skill:' (format field)"
