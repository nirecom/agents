# f-fault-injection.sh — B15: marker-write I/O fault injection for the
# background-work quiet-layer primitive. Kept in its own file (rather than in
# b-background-work.sh) because the write-then-rename failure contract is read
# as a unit and is the landing place for any future sibling primitive that
# shares that shape.
