...
# Tests: bin/vscode-patch-include-worktrees, bin/lib/vscode-patch-include-worktrees/prune.js, bin/lib/vscode-patch-include-worktrees/prune/execute.js, bin/lib/vscode-patch-include-worktrees/patch/apply.js
...
#
#   there is exactly one place under bin/lib/vscode-patch-include-worktrees/ where a
