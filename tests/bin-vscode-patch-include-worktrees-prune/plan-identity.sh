...
# Tests: bin/lib/vscode-patch-include-worktrees/prune/execute.js, bin/lib/vscode-patch-include-worktrees/prune.js, bin/lib/vscode-patch-include-worktrees/primitives.js
