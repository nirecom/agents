...
run_transitions_tests() {
  ...
  ACTION=""; NEXT_SKILL=""
  OUT="$(run_next_step --session "nonexistent-$$" 2>/dev/null || true)"
  ...
  OUT="$(run_next_step --session "case2" 2>/dev/null || true)"
  eval "$OUT" 2>/dev/null || true
  ...
  OUT="$(run_next_step --session "case3" 2>/dev/null || true)"
  eval "$OUT" 2>/dev/null || true
  ...
  OUT="$(run_next_step --session "case4" 2>/dev/null || true)"
  eval "$OUT" 2>/dev/null || true
  ...
  OUT="$(run_next_step --session "case7" 2>/dev/null || true)"
  eval "$OUT" 2>/dev/null || true
  ...
  OUT="$(run_next_step --session "case8" 2>/dev/null || true)"
  eval "$OUT" 2>/dev/null || true
  ...
  OUT="$(run_next_step --session "case9" 2>/dev/null || true)"
  eval "$OUT" 2>/dev/null || true
  ...
  OUT="$(run_next_step --session "case10" 2>/dev/null || true)"
  eval "$OUT" 2>/dev/null || true
  ...
  OUT="$(run_next_step --session "case11" 2>/dev/null || true)"
  eval "$OUT" 2>/dev/null || true
  ...
  OUT="$(run_next_step --session "case12" 2>/dev/null || true)"
  eval "$OUT" 2>/dev/null || true
  ...
  # next-step must abort with a non-empty NEXT_HINT (recovery hint).
  ACTION=""; REASON=""; NEXT_HINT=""
  write_state "case13b" "$JSON_CROSS_TASK_CONTAM"
  OUT="$(run_next_step --session "case13b" 2>/dev/null || true)"
  eval "$OUT" 2>/dev/null || true
