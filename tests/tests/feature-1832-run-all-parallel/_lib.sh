#!/usr/bin/env bash
# tests/tests/feature-1832-run-all-parallel/_lib.sh — shared fixture builder (SOURCE ONLY).
...
fx_new_root() {
    ...
    mkdir -p "$root/bin/lib" "$root/tests/bin" "$root/pids"
