...
# L3 seam body for subagent-start.js (SubagentStart) — L3 gap only.
# Sourced by ../L3-hook-subagent-start.sh.
#
...
# cannot be asserted reliably in an automated L3 seam test. Real coverage would require
