...
X_TABLE='
x-fix277           | CLEAN | tests/bin/fix-277-doc-append-merge-union.sh
x-bash-c-cd-scope  | CLEAN | tests/hooks/enforce-worktree-bash-c-cd-scope.sh
x-parallel-basics  | CLEAN | tests/agents/feature-parallel-sessions-worktree-bash-patterns/basics.sh
x-system-ops       | CLEAN | tests/hooks/feature-enforce-system-ops.sh
x-main-cleanup     | CLEAN | tests/hooks/fix-enforce-worktree-main-cleanup.sh
x-self             | CLEAN | tests/bin/fix-992-bare-python.sh
x-round6-identity  | CLEAN | tests/hooks/enforce-protected-marker-write/cases-round6-identity.sh
x-round6-stdin     | CLEAN | tests/hooks/enforce-protected-marker-write/cases-round6-stdin.sh
x-round7-proof     | CLEAN | tests/hooks/enforce-protected-marker-write/cases-round7-proof.sh
x-round8-operand   | CLEAN | tests/hooks/enforce-protected-marker-write/cases-round8-operand.sh
x-round12-attack   | CLEAN | tests/hooks/fix-1780-round12-classifier-attack-shapes.sh
x-round12-interp   | CLEAN | tests/hooks/fix-1780-round12-parser-unit-tables/cases-interpreter.sh
x-clear-consumer   | CLEAN | tests/hooks/enforce-clearance-token-write/consumer-allow-direction-cases.sh
x-clear-interp     | CLEAN | tests/hooks/enforce-clearance-token-write/interpreter-language-scope-cases.sh
x-clear-readonly   | CLEAN | tests/hooks/enforce-clearance-token-write/read-only-allowlist-cases.sh
xm-suffix-added    | HARD  | tests/bin/fix-992-bare-python-extra.sh
xm-prefixed-dir    | HARD  | nested/tests/bin/fix-992-bare-python.sh
xm-sibling-name    | HARD  | tests/hooks/enforce-protected-marker-write/cases-round6-identity2.sh
xm-deeper-dir      | HARD  | tests/hooks/enforce-protected-marker-write/sub/cases-round6-identity.sh
...
M3_OUT="$(mutant_run 's|^  "tests/bin/fix-277-doc-append-merge-union.sh"|  "tests/zzz-not-a-real-entry.sh"|')"
if grep -qF "HARD: tests/bin/fix-277-doc-append-merge-union.sh:" "$M3_OUT"; then
...
if grep -qF "HARD: tests/hooks/feature-enforce-system-ops.sh:" "$M3_OUT"; then
