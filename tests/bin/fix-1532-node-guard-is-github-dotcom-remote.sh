#!/usr/bin/env bash
# tests/bin/fix-1532-node-guard-is-github-dotcom-remote.sh
...
# filename stem, so this filename is what makes an edit to bin/is-github-dotcom-remote
...
GUARD_TARGET=is-github-dotcom-remote
