...
# shellcheck source=./bin-vscode-cc-repair-prune/classifier.sh
. "$PARTS_DIR/classifier.sh"
# shellcheck source=./bin-vscode-cc-repair-prune/planner-verify.sh
. "$PARTS_DIR/planner-verify.sh"
# shellcheck source=./bin-vscode-cc-repair-prune/counterpart-aggregation.sh
. "$PARTS_DIR/counterpart-aggregation.sh"
# shellcheck source=./bin-vscode-cc-repair-prune/record-grammar.sh
. "$PARTS_DIR/record-grammar.sh"
# shellcheck source=./bin-vscode-cc-repair-prune/scan.sh
. "$PARTS_DIR/scan.sh"
# shellcheck source=./bin-vscode-cc-repair-prune/lifecycle-race.sh
. "$PARTS_DIR/lifecycle-race.sh"
# shellcheck source=./bin-vscode-cc-repair-prune/execute-guard.sh
. "$PARTS_DIR/execute-guard.sh"
# shellcheck source=./bin-vscode-cc-repair-prune/backup-rotation.sh
. "$PARTS_DIR/backup-rotation.sh"
# shellcheck source=./bin-vscode-cc-repair-prune/plan-identity.sh
. "$PARTS_DIR/plan-identity.sh"
# shellcheck source=./bin-vscode-cc-repair-prune/plan-containment.sh
. "$PARTS_DIR/plan-containment.sh"
# shellcheck source=./bin-vscode-cc-repair-prune/plan-raw-deref.sh
. "$PARTS_DIR/plan-raw-deref.sh"
# plan-title-keys.sh reuses the drivers plan-raw-deref.sh defines, so it must follow it.
# shellcheck source=./bin-vscode-cc-repair-prune/plan-title-keys.sh
. "$PARTS_DIR/plan-title-keys.sh"
# shellcheck source=./bin-vscode-cc-repair-prune/cli-exit-codes.sh
. "$PARTS_DIR/cli-exit-codes.sh"
# shellcheck source=./bin-vscode-cc-repair-prune/packaging-structural.sh
