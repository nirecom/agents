...
# --- Setup: create temp directory structure simulating dotfiles + my-private-repo ---
TMPBASE="$(mktemp -d)"
...
# 6. No my-private-repo directory — scanner works
rm -rf "$FAKE_PRIVATE"

expect_clean "no my-private-repo directory — scanner works without error" \
    "some normal content"
