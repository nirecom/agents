...
# Tests: hooks/lib/workflow-state/completion-approval.js, hooks/lib/workflow-state/state-io.js, bin/workflow/next-step, hooks/workflow-mark/reset-handler.js
