...
const row = M["step-in-flight"] || {};
console.log("J1.present=" + Object.prototype.hasOwnProperty.call(M, "step-in-flight"));
...
console.log("J3.dep_type=" + typeof deps.anyStepInFlight);

console.log("J4.ttl=" + JSON.stringify(require(process.env.M_STEP_POLICY).STEP_IN_FLIGHT_TTL_MS));
console.log("J5.fn_type=" + typeof L.anyStepInFlight);
console.log("J5.compat_type=" + typeof L.isWriteCodeInFlight);
...
if require_js_ok "J: matrix probe"; then
    assert_js "J1 matrix declares the step-in-flight row" J1.present "true"
    ...
    assert_js "J5 lifecycle exports anyStepInFlight" J5.fn_type "function"
    assert_js "J5 lifecycle still exports isWriteCodeInFlight (back-compat)" J5.compat_type "function"
