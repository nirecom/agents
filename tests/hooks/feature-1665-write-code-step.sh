...
#
# #1665 commit 1 — write_code as a first-class workflow step (vocabulary insertion +
# all consumers that walk VALID_STEPS by position). Dispatcher: helpers in
# tests/hooks/feature-1665-write-code-step/common.sh; groups in a-vocabulary.sh..f-v2-to-v3.sh.
# TL3 gap: live PreToolUse routing, SKILL.md sentinel emission, permission auto-approve.
