#!/usr/bin/env bash
# tests/bin-vscode-patch-include-worktrees.sh
# Tests: bin/vscode-patch-include-worktrees
...
#   tests/bin-vscode-patch-include-worktrees/failclosed-paths.sh
...
PARTS_DIR="$AGENTS_DIR/tests/bin-vscode-patch-include-worktrees"
...
# shellcheck source=./bin-vscode-patch-include-worktrees/patch-lifecycle.sh
. "$PARTS_DIR/patch-lifecycle.sh"
# shellcheck source=./bin-vscode-patch-include-worktrees/classifier-verdicts.sh
. "$PARTS_DIR/classifier-verdicts.sh"
# shellcheck source=./bin-vscode-patch-include-worktrees/guard-cli.sh
. "$PARTS_DIR/guard-cli.sh"
# shellcheck source=./bin-vscode-patch-include-worktrees/failclosed-paths.sh
. "$PARTS_DIR/failclosed-paths.sh"
# shellcheck source=./bin-vscode-patch-include-worktrees/byte-integrity.sh
. "$PARTS_DIR/byte-integrity.sh"
# shellcheck source=./bin-vscode-patch-include-worktrees/cli-args.sh
. "$PARTS_DIR/cli-args.sh"
# shellcheck source=./bin-vscode-patch-include-worktrees/root-discovery.sh
. "$PARTS_DIR/root-discovery.sh"
# shellcheck source=./bin-vscode-patch-include-worktrees/dir-matching.sh
. "$PARTS_DIR/dir-matching.sh"
# shellcheck source=./bin-vscode-patch-include-worktrees/report-format.sh
. "$PARTS_DIR/report-format.sh"
# shellcheck source=./bin-vscode-patch-include-worktrees/packaging.sh
