...
OPUS_SKILLS="deep-research make-detail-plan clarify-intent make-outline-plan review-security write-tests"
...
OPUS_AGENTS="planner reviewer outline-planner outline-reviewer"
